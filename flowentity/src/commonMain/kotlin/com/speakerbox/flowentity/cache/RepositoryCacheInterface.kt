...
interface RepositoryCacheAllSourceInterface<Id: Any, EB: EntityBack<Id>> : EntityAllRepositoryInterface<Id, EB>

interface RepositoryCacheAllStorageInterface<Id: Any, EB: EntityBack<Id>> : RepositoryCacheAllSourceInterface<Id, EB>
{
